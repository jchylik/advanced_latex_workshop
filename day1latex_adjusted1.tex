...
In tikzpicture consists of nodes and edges. For noded we define their type, relative position, name, and displayed text. For edges we the define their shape and which nodes they are connecting, and we can also add a text to them.
