...
\begin{lstlisting}[language={python}       % listing: python code
 ...
 pick = random.randint(0, len(langs))       # pick randommly index
...
\lstinputlisting[ language={[latex]tex}     % new listing: tex syntax, latex option
  ...
  ,firstline=335                            % where in the file to start
  ,firstnumber=335                          % adjusting the shown numbers
  ,lastline=363                             % what is the last line
  ,numbers=left
