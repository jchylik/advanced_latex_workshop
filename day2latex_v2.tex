...
\chapter{Monday} \label{chap:monday}
 ...
 \begin{figure}[h!]
    ...
    \includegraphics[width=0.7\textwidth]{standalone.pdf}
...
We will start with:
%\input{./sillytext1.txt}  
\input{./sillytext2.txt}
...
\begin{lstlisting}[language={c},caption={Copy and paste code (example \alph{samplecode})},label={code:python}, 
...
\refstepcounter{samplecode} 
\lstinputlisting[ language={matlab}, %[latex]tex},      % tex syntax, latex option
...
]{./day2latex_backup.tex}   % code location
